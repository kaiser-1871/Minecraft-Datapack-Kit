...
resource('chicken_sound_variant', { since: '26.1' });
resource('chicken_variant', { since: '1.21.5' });
resource('cow_sound_variant', { since: '26.1' });
resource('cow_variant', { since: '1.21.5' });
resource('decorated_pot_pattern', { since: '26.3' });
...
resource('number_provider', { since: '26.3' });
resource('painting_variant', { since: '1.21' });
resource('pig_sound_variant', { since: '26.1' });
resource('pig_variant', { since: '1.21.5' });
resource('slot_source', { since: '26.3' });
...
resource('worldgen/carver', { since: '26.3' });
resource('worldgen/configured_carver', { since: '1.16.2', until: '26.3' });
resource('worldgen/configured_feature', { since: '1.16.2', until: '26.3' });
...
resource('worldgen/feature', { since: '26.3' });
resource('worldgen/flat_level_generator_preset', { since: '1.19' });
resource('worldgen/material_condition', { since: '26.3' });
resource('worldgen/material_rule', { since: '26.3' });
